...
PLANS: dict[str, dict] = {
    ...
    "bad_animation": {
        ...
        "change": ["motion_variation", "storyboard", "video", "cover"],
        "rerun_steps": ["motion_variation", "motion_storyboard", "asset_picker",
                        "motion_graphics", "cover_studio", "reel_auditor"],
        "needs_conductor": [],
        "strategy": "More dynamic variation + faster micro-scenes; re-render."},
    "visuals_too_basic": {
        "keep": ["research", "viral_fit", "angle", "hooks", "script", "voiceover"],
        ...
        "needs_conductor": [],
        "strategy": "New template + variation + asset combination for a premium look."},
    "too_slow": {
